...
<h3>Öğrendiklerim: </h3>
<ul>
<li> double number; -- Double Değişkenler </li>
<li> char symbol; -- Char Değişkenler </li>
<li> string passengerName; passengerName = console.ReadLine(); -- Klavyeden string Veri Girişi </li>
<li> int ShoeCount; shoeCount = int.Parse(Console.ReadLine()); -- Klavyeden int Veri Girişi </li>
<li> double exam1; exam1 = double.Parse(Console.ReadLine()); -- Klavyeden double Veri Girişi </li>
...
<h3>Öğrendiklerim:</h3>
<ul>
<li> if (password == "abcd") -- If Statement </li>
<li> int number; <br> number = 26; <br> int result = number % 5; <br> -- mod </li>
<li> switch (monthNumber) <br> {<br> case 1: <br>   Console.WriteLine("Ocak); <br>  break; <br>} <br> -- switch - case> </li>
</ul>
...
<h3>Öğrendiklerim:</h3>
<ul>
<li> for (int i = 0; i < 5 ; i ++) <br> { <br> Console.Writeline(i); <br>} <br> -- For Loop </li>
<li> for - if <br> For Loop with if statement </li>
<li> while (i <= 10) <br> {<br> Console.WriteLine(i); <br> i++; <br>}<br> -- While Loop </li>
</ul>
...
<h3>Öğrendiklerim:</h3>
<ul>
<li> DegiskenTuru [] DiziAdi = new DegiskenTuru[elemanSayisi]; <br> -- Dizi Oluşturma <br> string[] colors = new string[4]; </li>
<li> Dizideki Tüm elemanları Listeleme </li>
...
<li> Tabloya Nasıl veri eklenir </li>
<li> Select, from, where, insert, Update, Delete Kavramları nedir </li>
<li> SQL Bağlantısı nasıl yapılır </li>
<li> SQL de köprü görevi gören adapter nasıl oluşturulur ve nasıl kullanılır. </li>
<li> DataTable nedir ve nasıl oluşturulur </li>
</ul>
<br><br>
